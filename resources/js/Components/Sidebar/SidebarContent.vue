...
<template>
    ...
    >
        ...
        <SidebarCollapsible title="Users" :active="$page.url.startsWith('/users')">
            ...
            <SidebarCollapsibleItem :href="route('users.index')" title="List" :active="route().current('users.*')" />
            <SidebarCollapsibleItem :href="route('users.create')" title="Create" :active="route().current('users.*')" />
        </SidebarCollapsible>
